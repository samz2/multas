...
<body>
    @php
    $grado      = isset($grados) ? $grados->grado   : "Grado no existe";
    $seccion    = isset($grados) ? $grados->seccion : "Sección no existe";
    $nivel      = isset($grados) ? $grados->Nivel   : "Nivel no existe";
    $i = 1;
    @endphp
    <center>
        <table>
        ...
        <table border="1" style="font-size: 14px" cellpadding="0" cellspacing="0" >
            <tr>
                <td class="text-right fondo" width=80><b>Nivel: </b></td>
                <td width=300><b>{{$nivel}}</td>
            </tr>
            <tr>
                <td class="text-right fondo" width=80><b>Grado: </b></td>
                <td width=300><b>{{$grado}}</td>
            </tr>
            <tr>
                <td class="text-right fondo" width=80><b>Sección: </b></td>
                <td width=300><b>{{$seccion}}</td>
            </tr>
            <tr>
                <td class="text-right fondo" width=80><b>Tutor(a): </b></td>
        ...
        <table border="1" style="font-size: 14px" cellpadding="0" cellspacing="0">
            <tr class="fondo">
                <td colspan="2" class="text-center"  style="font-size: 16px"><b>ALUMNOS</b></td>
            </tr>
            <tr class="fondo">
